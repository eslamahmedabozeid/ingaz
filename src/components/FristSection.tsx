...
const FristSection = ({ t }: FristSectionProps) => {
  return (
    <div className="main-container h-[1037px] relative mx-auto my-0 overflow-hidden">
      ...
      <div className="max-sm:small_width w-[316.057px] h-[14.096px] bg-[url(/images/ef2aea87-650c-4b05-a805-9e916c7536e4.png)] bg-cover bg-no-repeat absolute top-[620.853px] rtl:left-[779.998px] ltr:left-[524.998px] z-[1]" />
