    ...
    <div className="w-full max-w-lg mx-auto space-y-4">
          ...
          {openIndex === 0 && (
            ...
            >
              ...
              <p className="text-[12px] font-black text-white-40 mt-4">
                التعلم الإلكتروني المتقدم، يستخدم منصات تفاعلية ومحاكاة ليوفر تجربة تدريب مرنة
                ومخصصة. يسهل على المتدربين من الوصول إلى الدورات واكتساب المهارات العملية في بيئة تفاعلية مشابهة للواقع.
              </p>
            </div>
          )}
        </div>
        ...
        >
          {openIndex === 1 && (
            ...
            >
              ...
              <p className="text-[12px] font-black text-white-40 mt-4">
                تتيح التفاعلية ويتيح للمتدربين الوصول إلى المحتوى أينما كانوا لاكتساب مهارات جديدة
                بشكل فعال ومباشر.
              </p>
            </div>
          )}
      ...
      <div className="border-b border-gray-700 rounded-t-lg overflow-hidden">
        ...
        >
          ...
          <span className="text-white">
            <img
              src={openIndex === 2 ? "/images/elementsclose.svg" : "/images/elements.svg"}
              alt="Toggle Icon"
              className="w-5 h-5"
            />
          </span>
